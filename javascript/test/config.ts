...
export const DOCKER_SQL_CONNECTION_STRING =
  "Server=localhost,1433;Database=vvocr;User Id=sa;Password=TestPassword123!;Encrypt=false;TrustServerCertificate=true";
...
export function getTestConfig(mode: TestMode): Record<string, string> {
  ...
  if (mode === "integration") {
    ...
    return {
      ...
      AI_PROJECT_KEY: "mock-ai-key-for-integration-tests-32chars",
      DOCUMENT_INTELLIGENCE_ENDPOINT: "https://mock-doc-intel.cognitiveservices.azure.com/",
      DOCUMENT_INTELLIGENCE_KEY: "mock-doc-intel-key-for-integration-tests",
