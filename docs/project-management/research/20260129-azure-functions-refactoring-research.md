...
# Task Research Notes: Azure Functions code Folder Refactoring
...
- **code/src/functions/api.ts** (1315 lines)
...
- **code/src/functions/documentProcessor.ts** (232 lines)
...
- **code/src/functions/aiProductMapper.ts** (516 lines)
...
- **code/src/functions/aiProductMapperQueue.ts** (73 lines)
  - Queue-triggered wrapper for aiProductMapper
  - Minimal duplication - good pattern

- **code/src/functions/getResults.ts** (176 lines)
...
- **code/src/functions/scheduledCleanup.ts** (47 lines)
  - Timer-triggered cleanup function
  - Usage tracking maintenance
  - Clean, focused implementation

- **code/src/functions/sanity.ts** (18 lines)
