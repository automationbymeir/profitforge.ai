...
- **code/test/unit/** (6 test files, ~1,900 lines)
...
- **code/test/integration/** (6 test files, ~850 lines)
...
- **code/test/e2e/** (2 test files, ~840 lines)
...
- **code/src/functions/http/** (Domain-organized HTTP endpoints)
...
- **code/src/utils/** (Shared utilities)
...
- `sample-documents/`: Test PDFs of various sizes and formats. you can find real ones from customer in [docs/](../../code/test/e2e/docs/)
- `mock-responses/`: Canned AI service responses. you can use processed ai mapping results at [tools/](../../code/test/tools/processed_e2e.json)
