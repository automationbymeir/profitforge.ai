---
goal: Refactor Azure Functions JavaScript folder structure for improved maintainability, scalability, and organization
version: 1.0
...
This implementation plan addresses the critical organizational and structural issues in the `javascript/` Azure Functions codebase. The current structure suffers from a 1315-line monolithic API file, duplicated code patterns, inconsistent architectural patterns, and lack of domain-based organization. This refactoring will improve code maintainability, enable better scalability, reduce duplication, and establish clear architectural boundaries.
...
- **FILE-001**: `javascript/src/middleware/cors.ts` - CORS middleware
- **FILE-002**: `javascript/src/middleware/auth.ts` - Authentication middleware
- **FILE-003**: `javascript/src/middleware/rate-limit.ts` - Rate limiting middleware
- **FILE-004**: `javascript/src/middleware/error-handler.ts` - Error handling middleware
- **FILE-005**: `javascript/src/middleware/index.ts` - Barrel exports

#### Phase 2: Services

- **FILE-006**: `javascript/src/services/document-service.ts` - Document business logic
- **FILE-007**: `javascript/src/services/vendor-service.ts` - Vendor business logic
- **FILE-008**: `javascript/src/services/version-service.ts` - Version management logic
- **FILE-009**: `javascript/src/services/ai-service.ts` - AI/OpenAI integration
- **FILE-010**: `javascript/src/services/ocr-service.ts` - Document Intelligence integration
- **FILE-011**: `javascript/src/services/storage-service.ts` - Blob storage operations
- **FILE-012**: `javascript/src/services/index.ts` - Barrel exports

#### Phase 3: Reorganized Functions

- **FILE-013**: `javascript/src/functions/http/documents/upload.ts`
- **FILE-014**: `javascript/src/functions/http/documents/get-results.ts`
- **FILE-015**: `javascript/src/functions/http/documents/delete.ts`
- **FILE-016**: `javascript/src/functions/http/documents/reprocess.ts`
- **FILE-017**: `javascript/src/functions/http/documents/confirm.ts`
- **FILE-018**: `javascript/src/functions/http/documents/ai-mapper.ts`
- **FILE-019**: `javascript/src/functions/http/vendors/delete.ts`
- **FILE-020**: `javascript/src/functions/http/versions/history.ts`
- **FILE-021**: `javascript/src/functions/http/versions/delete-run.ts`
- **FILE-022**: `javascript/src/functions/http/admin/usage.ts`
- **FILE-023**: `javascript/src/functions/http/health/sanity.ts`
- **FILE-024**: `javascript/src/functions/queues/ai-product-mapper.ts`
- **FILE-025**: `javascript/src/functions/blobs/document-processor.ts`
- **FILE-026**: `javascript/src/functions/timers/scheduled-cleanup.ts`

#### Phase 5: Models

- **FILE-027**: `javascript/src/models/document.ts`
- **FILE-028**: `javascript/src/models/vendor.ts`
- **FILE-029**: `javascript/src/models/product.ts`
- **FILE-030**: `javascript/src/models/version.ts`
- **FILE-031**: `javascript/src/models/api-responses.ts`
- **FILE-032**: `javascript/src/models/ocr.ts`
- **FILE-033**: `javascript/src/models/usage.ts`
- **FILE-034**: `javascript/src/models/index.ts`

### Files to Modify

- **FILE-035**: `javascript/src/functions/api.ts` - Extract handlers, then delete
- **FILE-036**: `javascript/src/functions/getResults.ts` - Move to new location
- **FILE-037**: `javascript/src/functions/aiProductMapper.ts` - Move to new location
- **FILE-038**: `javascript/src/functions/aiProductMapperQueue.ts` - Move to new location
- **FILE-039**: `javascript/src/functions/documentProcessor.ts` - Move to new location
- **FILE-040**: `javascript/src/functions/scheduledCleanup.ts` - Move to new location
- **FILE-041**: `javascript/src/functions/sanity.ts` - Move to new location
- **FILE-042**: `javascript/package.json` - Update main field for glob pattern
- **FILE-043**: `javascript/test/unit/*.test.ts` - Update imports and paths
- **FILE-044**: `javascript/test/integration/*.test.ts` - Update imports and API routes
- **FILE-045**: `javascript/test/e2e/*.test.ts` - Update imports and API routes
- **FILE-046**: `javascript/test/test-client.html` - Update API endpoints
- **FILE-047**: `javascript/test/results-viewer.html` - Update API endpoints

### Files to Delete

- **FILE-048**: `javascript/src/functions/api.ts` - After all handlers extracted (Phase 3)
- **FILE-049**: `javascript/src/functions/getResults.ts` - After moved (Phase 3)
- **FILE-050**: `javascript/src/functions/aiProductMapper.ts` - After moved (Phase 3)
- **FILE-051**: `javascript/src/functions/aiProductMapperQueue.ts` - After moved (Phase 3)
- **FILE-052**: `javascript/src/functions/documentProcessor.ts` - After moved (Phase 3)
- **FILE-053**: `javascript/src/functions/scheduledCleanup.ts` - After moved (Phase 3)
- **FILE-054**: `javascript/src/functions/sanity.ts` - After moved (Phase 3)
